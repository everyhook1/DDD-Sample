...
import org.example.cdc.SchemaAndTable;
...
public abstract class AbstractMySqlBinlogExtractor {
    ...
    private final Map<SchemaAndTable, Map<String, Integer>> columnOrders = new HashMap<>();
    private final ColumnOrderExtractor columnOrderExtractor;
